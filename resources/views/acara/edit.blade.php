            ...
            <div class="card-body ">
              <form class="form-horizontal" method="POST" action="{{ route('event.update', $event->id) }}">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="form-group has-default">
                      <input type="text" autocomplete="off" class="form-control" name="nama" id="nama" required value="{!! $event->nama !!}">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="text" autocomplete="off" class="form-control datepicker" name="tanggal_mulai" id="tanggal_mulai" required value="{!! $start->format('m/d/Y') !!}">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="text" autocomplete="off" class="form-control datepicker" name="tanggal_akhir" id="tanggal_akhir" required value="{!! $end->format('m/d/Y') !!}">
                    </div>
                  </div>
                </div>
